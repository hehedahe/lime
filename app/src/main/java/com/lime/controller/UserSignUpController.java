...
public class UserSignUpController {
  ...
  public Object signup(UserSignUp userSignUp, HttpServletResponse response, HttpSession session) {
  ...
  public Object signUp4(int regionId, int cityId,
    ...
    userSignUpService.add1(userLogin);
  ...
  private int sendEmail(HttpServletRequest request, String email) {
